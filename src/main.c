...
collider_t stage_col = {.box = {.pos = {GFX_LCD_WIDTH / 2, GFX_LCD_HEIGHT - 28 + 1}, .extent = {119, 28}}, .friction = 1.0f, .top_only = false};
// collider_t box_col = {.box = {.pos = {160, 110}, .extent = {20, 20}}, .friction = 0.3f};
collider_t platforms[] = {
    {.box = {.pos = {160, 110}, .extent = {24, 1.5f}}, .friction = 1.0f, .top_only = true},
    {.box = {.pos = {90, 140}, .extent = {24, 1.5f}}, .friction = 1.0f, .top_only = true},
    {.box = {.pos = {GFX_LCD_WIDTH - 90, 140}, .extent = {24, 1.5f}}, .friction = 1.0f, .top_only = true}
};
