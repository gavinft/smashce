...
collider_t stage_col = {.box = {.pos = {160, 190}, .extent = {130, 20}}, .layer = phy_layer_stage, .friction = 1.3f};
collider_t box_col = {.box = {.pos = {160, 110}, .extent = {20, 20}}, .layer = phy_layer_stage};
